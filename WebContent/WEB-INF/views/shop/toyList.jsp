...
<body>
    <div id="wrapper">
        ...
        <div id="nav"></div>
        <div id="contents">
            <p style="text-align: right; font-size: 13px;">홈 > <a href="/all?category=list">SHOPPING</a> > <a href="/toy?category=list">장난감</a></p>
            <legend id="legendtitle">상품 목록</legend><br>
            <div id="product_explain">${totalCount}개의 상품이 등록되어 있습니다.</div>
            <div id="product_filter">
                <a href="/toy?category=new"><span id="filtertext">최신순</span></a>|
                <a href="/toy?category=min"><span id="filtertext">낮은가격</span></a>|
                <a href="/toy?category=max"><span id="filtertext">높은가격</span></a>
            </div>
            <br>
            <hr>
             <c:set var="i" value="0" />
