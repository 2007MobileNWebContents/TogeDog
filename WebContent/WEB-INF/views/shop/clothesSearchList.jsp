    ...
    <div id="wrapper">
        ...
        <div id="contents">
            ...
            <div id="product_filter">
                <a href="/clothesSearch?search=${search }&category=new"><span id="filtertext">최신순</span></a>|
                <a href="/clothesSearch?search=${search }&category=min">낮은가격</span></a>|
                <a href="/clothesSearch?search=${search }&category=max"><span id="filtertext">높은가격</span></a>
            </div>
            <br>
            <hr>
             <c:set var="i" value="0" />
