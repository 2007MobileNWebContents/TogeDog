    ...
    <div id="wrapper">
        ...
        <div id="contents">
            ...
            <div id="product_filter">
                <a href="/allSearch?search=${search }&category=new"><span id="filtertext">최신순</span></a>|
                <a href="/allSearch?search=${search }&category=min"><span id="filtertext">낮은가격</span></a>|
                <a href="/allSearch?search=${search }&category=max"><span id="filtertext">높은가격</span></a>
            </div>
            <br>
            <hr>
             <c:set var="i" value="0" />
