...
<body>
   <div id="wrapper">
	...
	<form action="/comboard/modify" method="post">
                <legend style="text-align: left;">글 수정</legend>
                <hr><br><p id="textP">제목</p>
                <input type="text" size="70" placeholder="제목을 작성하세요" name="subject" value="${comboard.comSubject }" style="border: 1px solid black;"><br><br>
				<p id="textP">내용</p>
                <textarea rows="10" cols="72" placeholder="내용을 작성하세요" name="content" >${comboard.comContents }</textarea><br><br>
				<input type="hidden" name="comNoticeNo" value="${comboard.comNoticeNo }">
