...
<body>
    <div id="wrapper">
        ...
        <div id="contents">
        <div id="index"><a href="/index.jsp">홈</a> > <a href="/all?category=list">&nbsp;모든물품</a> > <a href="/toy?category=list">&nbsp;장난감</a></div>
            <div id="contents_header1">장난감</div>
            <div id="contents_header2">
                ...
                <div id="contents_filter">
                    <a href="/toySearch?search=${search }&category=new">최신순&emsp;&emsp;|</a>
                    <a href="/toySearch?search=${search }&category=min">낮은가격&emsp;&emsp;| </a>
                    <a href="/toySearch?search=${search }&category=max">높은가격</a>
                </div>
            </div>            
            <hr>
            <c:set var="i" value="0" />
            ...
            <div id="contents_search">
            	<form action="/toySearch" method="get">
