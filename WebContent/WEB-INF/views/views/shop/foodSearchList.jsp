        ...
        <div id="index"><a href="/index.jsp">홈</a> > <a href="/all?category=list">&nbsp;모든물품</a> > <a href="/food?category=list">&nbsp;사료 & 간식</a></div>
            ...
            <div id="contents_header2">
                ...
                <div id="contents_filter">
                    <a href="/foodSearch?search=${search }&category=new">최신순&emsp;&emsp;|</a>
                    <a href="/foodSearch?search=${search }&category=min">낮은가격&emsp;&emsp;| </a>
                    <a href="/foodSearch?search=${search }&category=max">높은가격</a>
                </div>
            </div>            
            <hr>
            <c:set var="i" value="0" />
