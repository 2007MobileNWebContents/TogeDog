...
<body>
    <div id="wrapper">
        ...
        <div id="contents">
        <div id="index"><a href="/index.jsp">홈</a> > <a href="/all?category=list">&nbsp;모든물품</a> > <a href="/clothes?category=list">&nbsp;의류</a></div>
            <div id="contents_header1">의류</div>
            <div id="contents_header2">
                ...
                <div id="contents_filter">
                    <a href="/clothesSearch?search=${search }&category=new">최신순&emsp;&emsp;|</a>
                    <a href="/clothesSearch?search=${search }&category=min">낮은가격&emsp;&emsp;| </a>
                    <a href="/clothesSearch?search=${search }&category=max">높은가격</a>
                </div>
            </div>            
            <hr>
            <c:set var="i" value="0" />
            ...
            <div id="contents_search">
            	<form action="/clothesSearch" method="get">
