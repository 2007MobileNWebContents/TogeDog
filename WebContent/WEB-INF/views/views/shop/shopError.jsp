...
<body>
    <div id="wrapper">
        ...
        <div id="contents">
            <div id="contents_header1"></div>
            <div id="contents_header2">
                <div id="contents_explain"></div>
                <div id="contents_empty"></div>
                <div id="contents_filter">
                    <a href="/allSearch?search=${search }&category=new">최신순&emsp;&emsp;|</a>
                    <a href="/allSearch?search=${search }&category=min">낮은가격&emsp;&emsp;| </a>
                    <a href="/allSearch?search=${search }&category=max">높은가격</a>
                </div>
            </div>            
            <hr>
            <br><br><br><div id="searcherror">검색하신 상품이 존재하지 않습니다.</div><br><br><br>
