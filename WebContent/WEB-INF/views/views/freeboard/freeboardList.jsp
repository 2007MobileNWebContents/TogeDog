...
<body>
	<div id="wrapper">
		<div id="head">
			<div id="head1">
				<a href="/views/member/cs.html" id="top">고객센터</a> <a href="#"
					id="top">장바구니</a> <a href="/view/member/enroll.html" id="top">회원가입</a>
				<a href="/views/member/login.jsp" id="top">로그인</a>
	...
	<ul id="ulTable">
		...
		<!-- 게시물이 출력될 영역 -->
		<li><c:forEach items="${fList }" var="freeboard"
				varStatus="index">
				<ul>
					<li>${freeboard.freeNoticeNo }</li>
					<li><a
						href="/freeboard/select?freeNoticeNo=${freeboard.freeNoticeNo }">${freeboard.freeSubject }</a></li>
					<li>${freeboard.freeUserId }</li>
					<li>${freeboard.freeRegDate }</li>
					<li>${freeboard.freeReadCount }</li>
				</ul>
			</c:forEach></li>
	</ul>
	<br>
