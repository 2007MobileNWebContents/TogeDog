...
<body>
	...
	<div id="nav"></div>
	<div id="contents">
		<p style="text-align: right; font-size: 13px;">홈 > 자유게시판 > 게시글 수정</p>


		<form action="/freeboard/modify" method="post">
			<legend id="legendtitle">글 수정</legend>
			<hr>
			<br>
			<p id="textP">제목</p>
			<input type="text" size="108" name="freeSubject"
				value="${freeboard.freeSubject }" style="border: 1px solid black;"><br>
			<br>
			<p id="textP">내용</p>
			<textarea rows="15" cols="110" name="freeContents">${freeboard.freeContents }</textarea>
			<br> <br> <input type="hidden" name="freeNoticeNo"
				value="${freeboard.freeNoticeNo }"> <input type="submit"
