...
<body>
	<div id="wrapper">
		...
		<div id="nav"></div>
		<div id="contents">
			<p style="text-align: right; font-size: 13px;">홈 > 정보공유 게시판 > 게시글</p>
			<div id="div1" style="text-align: center;">
				...
				<p id="textA">글번호 : ${content.comNoticeNo } / 글쓴이 :
					${content.comUserId } / 작성일 : ${content.comRegDate } / 조회수 :
					${content.comReadcount }</p>
				<textarea rows="20" cols="110" name="content">${content.comContents }</textarea>
				<br>
				...
				<c:if test="${sessionScope.member.userId eq content.comUserId }">
					...
					<input
						...
						href="/comboard/delete?comNoticeNo=${content.comNoticeNo }"
						onclick="return deleteConfirm();"> <input type="submit"
						value="삭제하기" id="buttonD"></a> 
						</c:if>
						<a href="/comboard/list">
				...
				<form action="BoardServlet" method="post" name="check">
					...
					<table style="font-size: 10px;">
						<tr>
							...
							<td><a href="/comboard/commentwrite"><input
